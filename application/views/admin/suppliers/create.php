        ...
        <div class="card-body">
            <form action="<?= base_url('index.php/admin/supplier_store'); ?>" method="POST">
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control" placeholder="Masukkan nama PT / Toko..." required>
                </div>
                ...
                <div class="form-group">
                    <label>Alamat</label>
                    <textarea name="address" class="form-control" rows="3" placeholder="Alamat lengkap supplier..." required></textarea>
                </div>
