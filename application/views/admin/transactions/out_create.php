<div class="container-fluid">
    ...
    <div class="card shadow col-lg-7">
        <div class="card-body">
            <form action="<?= base_url('index.php/admin/transaction_out') ?>" method="POST">
                ...
                <a href="<?= base_url('index.php/admin/transaction_out') ?>" class="btn btn-secondary btn-block">Batal</a>
